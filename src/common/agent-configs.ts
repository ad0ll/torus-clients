...
export const agentPublicConfigs: Record<string, AgentPublicConfig> = {
  'prediction-finder': {
    ...
    url: process.env.PREDICTION_FINDER_BASE_URL || 'https://trumptor.com/torus/prediction-finder',
    topLevel: true,
  ...
  'prediction-detector': {
    ...
    url: process.env.PREDICTION_DETECTOR_BASE_URL || 'https://trumptor.com/torus/prediction-detector',
    topLevel: false,
    contributionKey: '',
  },
  'bot-detector': {
    ...
    name: 'bot-detector',
    url: process.env.BOT_DETECTOR_BASE_URL || 'https://trumptor.com/torus/bot-detector',
    topLevel: false,
    contributionKey: '',
  },
  'prediction-verifier': {
    ...
    url: process.env.PREDICTION_VERIFIER_BASE_URL || 'https://trumptor.com/torus/prediction-verifier',
    topLevel: true,
  ...
  'openrouter-router': {
    ...
    url: process.env.OPENROUTER_ROUTER_BASE_URL || 'https://trumptor.com/torus/openrouter-router',
    topLevel: false,
    contributionKey: '',
  },
  'verdict-reasoning-agent': {
    ...
    url: process.env.VERDICT_REASONING_BASE_URL || 'https://trumptor.com/torus/verdict-reasoning',
    topLevel: true,
  ...
  'perplexity-bridge': {
    ...
    url: process.env.PERPLEXITY_BRIDGE_BASE_URL || 'https://trumptor.com/torus/perplexity-bridge',
    topLevel: false,
    contributionKey: '',
  },
  'prediction-context-finder': {
    ...
    url: process.env.PREDICTION_CONTEXT_FINDER_BASE_URL || 'https://trumptor.com/torus/prediction-context-finder',
    topLevel: true,
  ...
  'venice-bridge': {
    ...
    name: 'venice-bridge',
    url: process.env.VENICE_BRIDGE_BASE_URL || 'https://trumptor.com/torus/venice-bridge',
    topLevel: false,
    contributionKey: '',
  },
  'english-classifier': {
    ...
    url: process.env.ENGLISH_CLASSIFIER_BASE_URL || 'https://trumptor.com/torus/english-classifier',
    topLevel: false,
    contributionKey: '',
  },
  'prediction-verifiability-checker': {
    ...
    url: process.env.PREDICTION_VERIFIABILITY_CHECKER_BASE_URL || 'https://trumptor.com/torus/prediction-verifiability-checker',
    topLevel: false,
    contributionKey: '',
  },
  'messiah-finder': {
    address: '5DFVbaEs97PxJcqf96yoS2MzotN7EV3YNmD1FgNnkLqw98Gy' as SS58Address,
    name: 'messiah-finder',
    url: process.env.MESSIAH_FINDER_BASE_URL || 'https://trumptor.com/torus/messiah-finder',
    topLevel: false,
    contributionKey: '',
  },
};
