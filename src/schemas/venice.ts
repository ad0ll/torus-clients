...
export const veniceUsageSchema = z.object({
  ...
  prompt_tokens_details: z.object({}).nullable().optional(),
}).passthrough();
...
export const veniceChatCompletionsOkResponseSchema = z.object({
  ...
  prompt_token_ids: z.any().nullable().optional().describe('Token IDs for the prompt.'),
  service_tier: z.any().nullable().optional().describe('The service tier used for the request.'),
  system_fingerprint: z.any().nullable().optional().describe('System fingerprint for the request.'),
  kv_transfer_params: z.any().nullable().optional().describe('Key-value transfer parameters.'),
  venice_parameters: z
    .object({
